    ...
    return (
        <>
            ...
            {sectionData ? (
                ...
                >
                    <h2 className="text-5xl font-bold text-[#07293a]">NOS GRADUAMOS</h2>
                    ...
                    <div className="text-4xl font-bold">
                        <h3 className="text-4xl font-bold text-[#07293a]">2022 - 2025</h3>
                    </div>
                    <div className="flex flex-row items-center justify-center gap-2 md:gap-6 max-w-4xl mx-auto">
                        ...
                        <h3 className="text-3xl sm:text-4xl md:text-5xl font-bold text-[#8B5D3D] text-center md:text-start mt-4 md:mt-0">
                            PREPARATORIA
                        </h3>
                    </div>
                </motion.section>
